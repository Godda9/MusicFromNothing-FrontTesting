        ...
        <>
            <div className="col p-3 profile-card">
                <div className="bordered row g-0 border overflow-hidden flex-md-row mb-1 position-relative d-flex justify-content-center align-items-center">
                    <div className="d-mode-bg list-group-item list-group-item-action py-3 lh-tight d-flex justify-content-center" aria-current="true">
                        <div className='d-flex align-items-center justify-content-center flex-wrap'>
                            ...
                            <div className="d-flex flex-column mx-3 align-items-center justify-content-between text-center">
                                <div className="d-mode-text text-profile-following col-10 mb-1 small"><Icon.People/> Following 15</div>
                                <div className="d-mode-text text-profile-following col-10 mb-1 small"><Icon.People/> Followed 3</div>

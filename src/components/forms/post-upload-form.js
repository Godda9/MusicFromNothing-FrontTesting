...
const PostUploadForm = (props)=> {
    ...
    return(
        <>  
            <div className="bordered row border overflow-hidden shadow d-flex justify-content-center align-items-center w-50 p-5 m-5">
                <form onSubmit={handleSubmit(onSubmit)} className='column'>
                    ...
                    <div className='w-100 d-flex justify-content-between align-items-center'>
                        ...
                        <div className="pt-3">
                            <label htmlFor="ChooseAudio" className="form-label"><b>Choose own audio</b></label>
